...
Describe -Name 'Manifest' -Fixture {
    ...
    It -name 'has a valid license Uri' -test {
        $ManifestHash.PrivateData.Values.LicenseUri | Should Be 'https://github.com/janegilring/PSFootball/blob/master/LICENSE'
    }

    It -name 'has a valid project Uri' -test {
        $ManifestHash.PrivateData.Values.ProjectUri | Should Be 'https://github.com/janegilring/PSFootball'
    }
